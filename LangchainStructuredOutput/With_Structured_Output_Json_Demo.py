...
json_schema={
  ...
  "properties": {
    "key_themes": {
      "type": "array",
      "description": "Write down all the main themes discussed in the review in a list",
      "items": {
        "type": "string"
      }
    },
    ...
    "pros": {
      "type": "array",
      "description": "List the pros mentioned in the review, if any",
      "items": {
        "type": "string"
      },
      "nullable": true
    ...
    "cons": {
      "type": "array",
      "description": "List the cons mentioned in the review, if any",
      "items": {
        "type": "string"
      },
      "nullable": true
