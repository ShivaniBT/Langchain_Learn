...
model=ChatOpenAI(model="gpt-4o")
    ...
    # key_themes: Annotated[str,"Write down all the main themes discussed in the review in a list"]
...
class Review(BaseModel):
    key_themes: list[str] = Field(description="Write down all the main themes discussed in the review in a list")
...
# model -> schema using TypedDict -> structured model -> invoke -> structured result
